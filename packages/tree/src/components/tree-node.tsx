    ...
    return () => (
      <div
        class={classNames({
          ...
          'leading-7': true,
          'block-node': true,
          'hover:bg-slate-200': blockNode.value
        })}
        style={{
      ...
      >
        ...
        {!treeNode.value.isLeaf &&
          ...
          showLine.value && (
            <span
              class="s-tree-line absolute w-px bg-gray-300 z-10"
              style={{
        ...
        >
          ...
          <div
            class={classNames({
              ...
              flex: true,
              'items-center': true,
              'justify-between': blockNode.value
                ? true
                : blockLine.value
                  ? true
                  : false,
              'hover:bg-slate-200': blockLine.value
            })}
          >
            {/* 标签 */}
            <div
