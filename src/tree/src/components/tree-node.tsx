...
export default defineComponent({
  ...
  setup(props: TreeNodeProps, { slots }) {
    ...
    return () => (
      <div
        class="s-tree__node hover:bg-slate-300 relative leading-7 "
        style={{
      ...
      >
        {/* 连接线 */}
        {!treeNode.value.isLeaf && treeNode.value.expanded && showLine.value && (
          <span
        ...
        <div
          class="s-tree__node--content flex justify-between"
          {...draggableProps}
        >
          <div>
            {/* 折叠图标 */}
